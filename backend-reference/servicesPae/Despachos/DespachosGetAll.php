...
/* =========================
   WHERE dinámico
   IMPORTANTE:
   - Este servicio lista SOLO despachos clásicos.
   - Si tipoDespacho está NULL en registros antiguos, se toma como CLASICO.
========================= */
$where  = [];
$types  = "";
$params = [];

$where[] = "COALESCE(d.tipoDespacho, 'CLASICO') = 'CLASICO'";
...
while ($st->fetch()) {
  $data[] = [
    ...
    "tipoDespacho" => $tipoDespacho ?: "CLASICO",
...
jexit(200, [
  "rpta" => "si",
  "mensaje" => "Despachos clásicos consultados correctamente",
  "filtros" => [
    "page" => $page,
    "limit" => $limit,
    "q" => $q,
