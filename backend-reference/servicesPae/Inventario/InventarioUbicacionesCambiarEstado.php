...
if ($id <= 0) {
  jexit(400, [
    "rpta" => false,
    "mensaje" => "El id de la ubicación es obligatorio."
  ]);
}
...
if (!$stmtExiste) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error preparando validación de ubicación.",
    "error" => $mysqli->error
  ]);
}
...
if (!$stmtExiste->execute()) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error ejecutando validación de ubicación.",
...
if (!$stmt->execute()) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error cambiando estado de la ubicación.",
    "error" => $stmt->error
  ]);
}
...
jexit(200, [
  "rpta" => true,
  "mensaje" => $estado === 1 ? "Ubicación activada correctamente." : "Ubicación inactivada correctamente.",
  "data" => [
    "id" => $id,
    "estado" => $estado
  ]
