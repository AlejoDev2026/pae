...
if (!$stmt) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error preparando consulta de tipos de producto.",
    "error" => $mysqli->error
  ]);
}
...
if (!$stmt->execute()) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error ejecutando consulta de tipos de producto.",
    "error" => $stmt->error
  ]);
}
...
jexit(200, [
  "rpta" => true,
  "mensaje" => "Tipos de producto consultados correctamente.",
  "filtros" => [
    "q" => $q,
    "estado" => $estado
  ],
