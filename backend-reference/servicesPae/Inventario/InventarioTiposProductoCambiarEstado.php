...
if (!$stmtExiste) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error preparando validación de tipo de producto.",
    "error" => $mysqli->error
  ]);
}
...
if (!$stmtExiste->execute()) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error ejecutando validación de tipo de producto.",
...
if (!$stmt->execute()) {
  jexit(500, [
    "rpta" => false,
    "mensaje" => "Error cambiando estado del tipo de producto.",
    "error" => $stmt->error
  ]);
}
...
jexit(200, [
  "rpta" => true,
  "mensaje" => $estado === 1 ? "Tipo de producto activado correctamente." : "Tipo de producto inactivado correctamente.",
  "data" => [
    "id" => $id,
    "estado" => $estado
  ]
