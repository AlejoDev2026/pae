...
export const InformesDespachoold = ({ setSidebar, navegar }) => {
    ...
    const [informeActivo, setInformeActivo] = useState("POR_RUTA");
    ...
    const construirPaqueteExportacionRutaFormato = () => ({
        ...
        despacho: informeRutaFormato?.despacho || despacho,
    ...
    const obtenerPaqueteExportacionJornada = async () => {
        ...
        return {
            ...
            despacho: response?.data?.despacho || despacho,
                    ...
                    <nav className="w-full flex items-center justify-between mb-4 md:mb-6 gap-4 shrink-0">
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                onClick={() => estadoPagina("DetalleDespacho")}
                                type="button"
                            >
