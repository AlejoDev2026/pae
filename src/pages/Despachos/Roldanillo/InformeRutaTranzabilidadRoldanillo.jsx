...
export const InformeRutaTranzabilidadRoldanillo = ({
    setSidebar,
    navegar,
    idDespacho,
    idCategoria = 21,
    ...
    useEffect(() => {
        ...
        const cargarInforme = async () => {
            try {
                ...
                const url = `${API_BASE}Despachos/Roldanillo/DespachosGetInformeRutaEspecialConsolidado.php?idDespacho=${idDespachoResuelto}&idCategoria=${idCategoria}`;
                console.log(url);
...
export default InformeRutaTranzabilidadRoldanillo;