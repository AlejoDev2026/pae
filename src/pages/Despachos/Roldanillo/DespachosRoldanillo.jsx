...
export const DespachosRoldanillo = ({
    setSidebar,
    navegar
}) => {
    ...
    const obtenerDespachos = async () => {
        try {
            ...
            const url = `${API_BASE}Despachos/Roldanillo/DespachosGetAll.php?contrato=roldanillo`;
            console.log('url', url);
                ...
                <article className="flex-1 bg-white shadow-lg rounded-lg p-6 flex flex-col overflow-hidden">
                    <nav className="w-full flex flex-row items-center justify-between mb-4 gap-6">
                        ...
                        <button
                            ...
                            onClick={() => estadoPagina("NuevoDespachoRoldanillo")}
                        >
