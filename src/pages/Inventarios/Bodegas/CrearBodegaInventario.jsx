...
export const CrearBodegaInventario = ({ setSidebar, navegar }) => {
  ...
  const guardarBodega = async (e) => {
    ...
    try {
      ...
      if (!response.rpta) {
        toast.error(response.mensaje || "No se pudo guardar la bodega");
        return;
      }

      toast.success(response.mensaje || "Bodega guardada correctamente");
  ...
  return (
    <div className="w-full h-screen flex flex-col p-6 gap-6 bg-slate-100">
      <div className="flex items-center gap-5 lg:hidden">
        ...
        <h1 className="text-lg font-bold">Crear bodega</h1>
      </div>
      ...
      <article className="flex-1 bg-white shadow-lg rounded-2xl flex flex-col overflow-hidden border border-slate-200">
        <nav className="w-full px-6 py-5 border-b border-slate-200 bg-white">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Registra una nueva bodega para el control de inventario.
                </p>
              </div>
            </div>
            ...
            >
              <FaSave />
              <span>{guardando ? "Guardando..." : "Guardar bodega"}</span>
            </button>
          </div>
        </nav>

        <form
          onSubmit={guardarBodega}
                ...
                <div className="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                  <div className="px-5 py-4 border-b border-slate-200 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Completa los datos principales para crear la bodega.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div className="p-5">
                      ...
                      <p className="mt-3 text-sm text-slate-500 leading-relaxed">
                        ...
                        <strong className="text-slate-700">BOD-SECO</strong>,{" "}
                        <strong className="text-slate-700">BOD-FRIA</strong> o{" "}
