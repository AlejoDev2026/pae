...
export const CrearCodigoBarrasInventario = ({ setSidebar, navegar }) => {
    ...
    const guardarCodigo = async (e) => {
        ...
        try {
            ...
            if (!json.rpta) {
                toast.error(json.mensaje || "No se pudo guardar el código de barras");
                return;
            }

            toast.success(json.mensaje || "Código de barras guardado correctamente");
            estadoPagina("CodigosBarrasInventario");
        } catch (error) {
            console.error(error);
            toast.error("Ocurrió un error al guardar el código de barras");
        } finally {
            setGuardando(false);
        }
    };
    ...
    return (
        <div className="w-full h-screen flex flex-col p-6 gap-6 bg-slate-100">
            <div className="flex items-center gap-5 lg:hidden">
                ...
                <h1 className="text-lg font-bold">Crear código de barras</h1>
            </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    Asocia un código de barras a un producto registrado.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                                    <div className="px-5 py-4 border-b border-slate-200 flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-500">
                                                Busca el producto desde el modal y registra su código de barras.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-5 space-y-4">
                                        <div className="flex flex-col gap-1.5">
                                                        ...
                                                        <div className="flex items-start gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-xs text-slate-400 mt-0.5">
                                                                    {productoSeleccionado.codigoGrupo || "Sin grupo"} ·{" "}
                                                                    {productoSeleccionado.categoriaProducto ||
                                                                        "Sin categoría"} ·{" "}
                                                                    {productoSeleccionado.tipoProductoInventario ||
                                                                        "Sin tipo inventario"}
                                                                </p>
                                                            </div>
                                                        </div>
                                            ...
                                            <span className="text-xs text-slate-400">
                                                Recomendado para listas grandes de productos.
                                            </span>
                                        </div>
                                    ...
                                    <div className="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
                                        ...
                                        <div className="p-5">
                                            ...
                                            <p className="mt-3 text-sm text-slate-500 leading-relaxed">
                                                Puedes registrar varios códigos para un mismo producto,
                                                pero solo uno debe quedar como principal para lectura rápida.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {productosFiltrados.length === 0 ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {productosFiltrados.map((item) => {
                                        const seleccionado = Number(item.id) === Number(form.idProducto);
